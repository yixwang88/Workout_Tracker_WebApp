...
return (
    ...
    <div className="container mx-auto px-6">
      {/* Title */}
      <h2 className="text-3xl font-bold text-center">Bench Press</h2>

      <div className="mt-10 flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-12">
        {/* Exercise Image */}
        <div className="bg-white rounded-lg shadow-lg p-4">
          <img 
            // src="https://via.placeholder.com/300" // Replace with actual exercise image
            alt="Bench Press" 
            className="rounded-md grayscale"
          />
          <p className="mt-4 text-lg"><strong>Primary Target:</strong> Chest</p>
          <p className="text-lg"><strong>Secondary Target:</strong> Shoulders</p>
        </div>
